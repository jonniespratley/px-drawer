...
function runBaseTests() {
  px_drawer_1 = document.getElementById('px_drawer_1');

  suite('Base Automation Tests for px-drawer', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-drawer fixture is created', function() {
      assert.isTrue(document.getElementById('px_drawer_1') !== null);
    });
